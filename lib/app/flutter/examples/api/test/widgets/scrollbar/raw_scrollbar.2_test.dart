...
import 'package:flutter_api_samples/widgets/scrollbar/raw_scrollbar.2.dart' as example;
import 'package:flutter_test/flutter_test.dart';

void main() {
  testWidgets('The scrollbar remains visible', (WidgetTester tester) async {
