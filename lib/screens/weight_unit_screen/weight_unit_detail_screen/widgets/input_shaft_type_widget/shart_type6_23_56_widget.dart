...
class ShartType62356Widget extends StatefulWidget {
  const ShartType62356Widget({
    super.key,
    required this.hint,
  ...
  final int shaft1, shaft23, shaft4, shaft56;
  final bool? isDisable;

  @override
  State<ShartType62356Widget> createState() => _ShartType62356WidgetState();
}

class _ShartType62356WidgetState extends State<ShartType62356Widget> {
  ...
  void shaft56(String value) {
    ...
    double result = shaft5 + shaft6;
    if (widget.shaft56 < result) {
      setState(() {
  ...
  void calOverShaft() {
    ...
    double result4 = shaft4 + shaft5 + shaft6;
    if (widget.shaft56 < result4) {
      setState(() {
        isOverShaft56 = true;
      });
    } else {
    ...
    if (isOverShaft1 == true && isOverShaft23 == true && isOverShaft4 == true && isOverShaft56 == true) {
      isOverShaft = false;
    } else {
      if (isOverShaft1 || isOverShaft23 || isOverShaft4 || isOverShaft56) {
        isOverShaft = true;
      } else {
        isOverShaft = false;
      }
