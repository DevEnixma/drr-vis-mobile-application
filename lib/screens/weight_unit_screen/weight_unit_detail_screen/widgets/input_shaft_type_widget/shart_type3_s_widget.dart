...
class ShartType3sWidget extends StatefulWidget {
  const ShartType3sWidget({
    super.key,
    required this.hint,
  ...
  final int shaft1, shaft2, shaft3;
  final bool? isDisable;

  @override
  State<ShartType3sWidget> createState() => _ShartType3sWidgetState();
}

class _ShartType3sWidgetState extends State<ShartType3sWidget> {
  ...
  void shaft3(String value) {
    ...
    double result = shaft3;
    if (widget.shaft3 < result) {
      setState(() {
  ...
  void calOverShaft() {
    ...
    if (isOverShaft1 == true && isOverShaft2 == true && isOverShaft3 == true) {
      isOverShaft = false;
    } else {
      if (isOverShaft1 || isOverShaft2 || isOverShaft3) {
        isOverShaft = true;
      } else {
        isOverShaft = false;
      }
