...
class ShartType3Widget extends StatefulWidget {
  const ShartType3Widget({
    super.key,
    required this.hint,
  ...
  final int shaft1, shaft23;
  final bool? isDisable;

  @override
  State<ShartType3Widget> createState() => _ShartType3WidgetState();
}

class _ShartType3WidgetState extends State<ShartType3Widget> {
  ...
  void calOverShaft() {
    ...
    if (isOverShaft1 == true && isOverShaft23 == true) {
      isOverShaft = false;
    } else {
      if (isOverShaft1 || isOverShaft23) {
        isOverShaft = true;
      } else {
        isOverShaft = false;
      }
