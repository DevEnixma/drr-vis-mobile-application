...
class ShartType4sWidget extends StatefulWidget {
  const ShartType4sWidget({
    super.key,
    required this.hint,
  ...
  final int shaft1, shaft2, shaft34;
  final bool? isDisable;

  @override
  State<ShartType4sWidget> createState() => _ShartType4sWidgetState();
}

class _ShartType4sWidgetState extends State<ShartType4sWidget> {
  ...
  void calOverShaft() {
    ...
    double result3 = shaft4 + shaft3;
    if (widget.shaft34 < result3) {
      setState(() {
        isOverShaft34 = true;
      });
    } else {
    ...
    if (isOverShaft1 == true && isOverShaft2 == true && isOverShaft34 == true) {
      isOverShaft = false;
    } else {
      if (isOverShaft1 || isOverShaft2 || isOverShaft34) {
        isOverShaft = true;
      } else {
        isOverShaft = false;
      }
