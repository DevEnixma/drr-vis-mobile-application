...
class ShartType7SWidget extends StatefulWidget {
  const ShartType7SWidget({
    super.key,
    required this.hint,
  ...
  final int shaft12, shaft34, shaft567;
  final bool? isDisable;

  @override
  State<ShartType7SWidget> createState() => _ShartType7SWidgetState();
}

class _ShartType7SWidgetState extends State<ShartType7SWidget> {
  ...
  void shaft567(String value) {
    ...
    double result4 = shaft5 + shaft6 + shaft7;
    if (widget.shaft567 < result4) {
      setState(() {
  ...
  void calOverShaft() {
    ...
    if (widget.shaft567 < result4) {
      ...
      setState(() {
        isOverShaft567 = false;
      });
    }

    if (isOverShaft12 == true && isOverShaft34 == true && isOverShaft567 == true) {
      isOverShaft = false;
    } else {
      if (isOverShaft12 || isOverShaft34 || isOverShaft567) {
        isOverShaft = true;
      } else {
        isOverShaft = false;
      }
